...
import ai.achaialabs.helios.heliosApp.data.local.dao.HomeFeedTypeConverter
...
@Database(
    entities = [PromptEntity::class, HomeFeedEntity::class, HomeHeroEntity::class, UserEntity::class, CategoryEntity::class, ToolEntity::class],
    version = 14
)

@TypeConverters(HomeFeedTypeConverter::class)
